...
public class EditItemsActivity extends AppCompatActivity {
    ...
    private MaterialCardView delete_this_item;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delete_this_item = findViewById(R.id.delete_this_item);
        ...
        editTextItemName.setText(getIntent().getStringExtra("item_name"));

        editTextMrp.setText(getIntent().getStringExtra("item_mrp"));
        editTextDiscount.setText(getIntent().getStringExtra("discount"));
        editTextGst.setText(getIntent().getStringExtra("gst")+"%");
        editTextItemsDescription.setText(getIntent().getStringExtra("description"));

        isItemActive = getIntent().getStringExtra("is_item_active");


        extraField1Title.setText(getIntent().getStringExtra("extra_1_title"));
        extraField1Value.setText(getIntent().getStringExtra("extra_1_value"));
        extraField2Title.setText(getIntent().getStringExtra("extra_2_title"));
        extraField2Value.setText(getIntent().getStringExtra("extra_2_value"));
        extraField3Title.setText(getIntent().getStringExtra("extra_3_title"));
        extraField3Value.setText(getIntent().getStringExtra("extra_3_value"));
        ...
        if(!getIntent().getStringExtra("image1").equals("")){
            imgGallery2.setVisibility(View.VISIBLE);
            Glide.with(EditItemsActivity.this)
        ...
        if(getIntent().getStringExtra("number_of_extra_fields").equals("0")){
            numberOfExtraFields=0;
        } else if(getIntent().getStringExtra("number_of_extra_fields").equals("1")){
        ...
        } else if(getIntent().getStringExtra("number_of_extra_fields").equals("2")){
        ...
        } else if(getIntent().getStringExtra("number_of_extra_fields").equals("3")){
        ...
        itemCategorySpinner.setSelection(Integer.parseInt(getIntent().getStringExtra("category_position")));
        piecesUnitSpinner.setSelection(Integer.parseInt(getIntent().getStringExtra("unit_position")));
        ...
        btnItemsAddDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isImg1Success && isImg2Success && isImg3Success && isImg4Success && isImg5Success) {
                    ...
                    Toast.makeText(EditItemsActivity.this, "Please Wait Image is uploading", Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast.makeText(EditItemsActivity.this, "Description cannot be empty.", Toast.LENGTH_SHORT).show();
                                }


                            } else{
                                Toast.makeText(EditItemsActivity.this, "GST should be in number or leave empty if not applicable", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(EditItemsActivity.this, "Discount should be in number or in percentage only. also can Leave empty", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(EditItemsActivity.this, "MRP field cannot be empty", Toast.LENGTH_SHORT).show();
                    }


                } else {
                    Toast.makeText(EditItemsActivity.this, "Item name cannot be empty.", Toast.LENGTH_SHORT).show();
                }
        ...
        new AlertDialog.Builder(EditItemsActivity.this)
                ...
                .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        FirebaseFirestore.getInstance().collection("_" + PhoneNumber.getPhoneNumber() + "_items")
                                .document(itemId).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {

                                            Toast.makeText(EditItemsActivity.this, "Deleted Successfully", Toast.LENGTH_SHORT).show();
                                            onBackPressed();
                                        } else {
                                            Toast.makeText(EditItemsActivity.this, "Failed to delete", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    }
    ...
    private void saveToFireStore() {
        ...
        db.collection("_" + PhoneNumber.getPhoneNumber() + "_items").document(itemId).set(items, SetOptions.merge())
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(EditItemsActivity.this, "Successful", Toast.LENGTH_SHORT).show();
                        onBackPressed();
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(EditItemsActivity.this, "Sorry, there is something wrong.", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void upload4Image() {
        ...
        if (isImage4.equals("1")) {
            try {
                ...
                imageBitmap  = MediaStore.Images.Media.getBitmap(EditItemsActivity.this.getContentResolver(), imgGallery4URI);
    ...
    private void upload1Image() {
        ...
        if (isImage1.equals("1")) {
            ...
            try {
                ...
                imageBitmap  = MediaStore.Images.Media.getBitmap(EditItemsActivity.this.getContentResolver(), imgGallery1URI);
    ...
    private void upload3Image() {
        ...
        if (isImage3.equals("1")) {
            try {
                ...
                imageBitmap  = MediaStore.Images.Media.getBitmap(EditItemsActivity.this.getContentResolver(), imgGallery3URI);
    ...
    private void upload5Image() {
        if (isImage5.equals("1")) {
            try {
                ...
                imageBitmap  = MediaStore.Images.Media.getBitmap(EditItemsActivity.this.getContentResolver(), imgGallery5URI);
    ...
    private void upload2Image() {
        ...
        if (isImage2.equals("1")) {
            try {
                ...
                imageBitmap  = MediaStore.Images.Media.getBitmap(EditItemsActivity.this.getContentResolver(), imgGallery2URI);
    ...
    public void uupload1() {
        ...
        if (isImage1.equals("1")) {
            ...
            image1Reference.putBytes(imgGallery1Byte).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(EditItemsActivity.this, "Image 1 not uploaded", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            isImg1Success = true;
    ...
    public void uupload2() {
        ...
        if (isImage2.equals("1")) {
            ...
            image2Reference.putBytes(imgGallery2Byte).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(EditItemsActivity.this, "Image 2 not uploaded", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    public void uupload3() {
        ...
        if (isImage3.equals("1")) {
            ...
            image3Reference.putBytes(imgGallery3Byte).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(EditItemsActivity.this, "Image 3 not uploaded", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    public void uupload4() {
        ...
        if (isImage4.equals("1")) {
            ...
            image4Reference.putBytes(imgGallery4Byte).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(EditItemsActivity.this, "Image 4 not uploaded", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    public void uupload5(){
        ...
        if (isImage5.equals("1")) {
            ...
            image5Reference.putBytes(imgGallery5Byte).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(EditItemsActivity.this, "Image 5 not uploaded", Toast.LENGTH_SHORT).show();
                }
            });
